...
public class RestAPI {
    ...
    @PostMapping("/login/check-token")
    public ResponseEntity<LoginDTO> checkToken(@RequestParam(required = false, name = "token") String token) {
    ...
    public ResponseEntity<String> changePassword(@RequestParam(required = false, name = "passwordold") String passwordOld,
        ...
        try
        {
            ...
            {
                String result = userService.changePassword(passwordOld, passwordNew, userDTO.getToken().getUserid());
    ...
    public ResponseEntity<String> changePasswordAdmin(@RequestParam(required = false, name = "passwordnew") String passwordNew,
        ...
        try
        {
            ...
            UserDTO userDTO = userService.login(null, null, token);
            if (userDTO.getResult().equals("Token is valid") && userDTO.getUser().getRole().equals("admin"))
            {
    ...
    @PutMapping("/users")
    public ResponseEntity<User> saveUser(User user, @RequestParam(name = "token", required = false) String token,
                                         @RequestParam(name = "usernameold", required = false) String usernameOld) {

        try {
            UserDTO userDTO = userService.login(null, null, token);
            if (userDTO.getResult().equals("Token is valid")) {
                if (userDTO.getToken().getRole().equals("admin"))
                {
                    //System.out.println("Test");
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PostMapping("/users")
    public ResponseEntity<User> addUser(User user, @RequestParam(name = "token", required = false) String token) {
    ...
    public ResponseEntity<UserDTOReturnToClient> searchUsers(@RequestParam(name = "username", required = false) String username,
        ...
        try {
            System.out.println("Test");
            if (userService.login(null, null, token).getResult().equals("Token is valid")) {
                if (!username.equals("")) {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @DeleteMapping("/users")
    public ResponseEntity<User> addUser(@RequestParam(name = "token", required = false) String token,
    ...
    @ResponseBody
    public ResponseEntity<PublishingCompanyDTO> getPublishingCompanyList(@RequestParam(required = false, name = "token") String token,
    ...
    public ResponseEntity<PublishingCompanyDTO> searchPublishingCompany(@RequestParam(name = "publishingcompanyid", required = false) String publishingCompanyID,
                                                ...
                                                @RequestParam(name = "token", required = false) String token) {
        try {
            System.out.println(publishingCompanyID + publishingCompanyName);
            if (userService.login(null, null, token).getResult().equals("Token is valid")) {
    ...
    public ResponseEntity<String> saveBook(Book book, @RequestParam(required = false) Map<String, String> authorIDMap,
        ...
        try {
            UserDTO userDTO = userService.login(null, null, token);
            if (userDTO.getResult().equals("Token is valid")) {
                if (Objects.equals(userDTO.getToken().getRole(), "admin"))
                {
    ...
    public ResponseEntity<String> deleteBook(@RequestParam(name = "bookid") String bookid,
        ...
        try {
            ...
            if (userDTO.getResult().equals("Token is valid")) {
                ...
                {
                    return new ResponseEntity<>("Xoá sách thất bại !", HttpStatus.BAD_REQUEST);
                }
    ...
    public ResponseEntity<String> deleteStaff(@RequestParam(name = "token", required = false) String token,
                                               @RequestParam(name = "staffid", required = false) String staffid) {
        try {
            UserDTO userDTO = userService.login(null, null, token);
            System.out.println(userDTO.getResult());
            if (userDTO.getResult().equals("Token is valid")) {
                if (userDTO.getToken().getRole().equals("admin"))
                {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PutMapping("/authors")
    public ResponseEntity<String> saveAuthor(Author author, @RequestParam(name = "token", required = false) String token,
                                               @RequestParam(name = "authoridold", required = false) String authorIDOld) {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PostMapping("/authors")
    public ResponseEntity<Author> addAuthor(Author author, @RequestParam(name = "token", required = false) String token) {
    ...
    public ResponseEntity<Author> deleteAuthor(@RequestParam(name = "token", required = false) String token,
    ...
    @ResponseBody
    public ResponseEntity<String> addBookAuthor(BookAuthor bookAuthor, @RequestParam(name = "token") String token) {
        try {
            UserDTO userDTO = userService.login(null, null, token);
            if (userDTO.getResult().equals("Token is valid")) {
                if (userDTO.getToken().getRole().equals("admin"))
    ...
    @ResponseBody
    public ResponseEntity<String> updateBookAuthor(BookAuthor bookAuthor, @RequestParam(name = "token") String token) {
        try {
            UserDTO userDTO = userService.login(null, null, token);
            if (userDTO.getResult().equals("Token is valid")) {
                if (userDTO.getToken().getRole().equals("admin"))
    ...
    public ResponseEntity<String> deleteBorrowPay(@RequestParam(name = "borrowpayid", required = false) Integer borrowPayID,
        ...
        try {
            ...
            if (userDTO.getResult().equals("Token is valid")) {
                ...
                {
                    return new ResponseEntity<>("Xoá thất bại", HttpStatus.BAD_REQUEST);
                }
            } else {
                return new ResponseEntity<>(null, HttpStatus.REQUEST_TIMEOUT);
            }
